...
# # 방탄소년단의 노래에 대해서만, 고경과 곡명의 글자수를 출력
...
#         title: str = song_dict["title"]
#         bts_list.append(title)

# for title in bts_list:
#     print(title)


# def get_title_and_length_song(song_dict):
#     title: str = song_dict["title"]
#     return title


# def check_length_song(song_dict):
#     return len(song_dict[("artist")]) >= 3


# for title in map(get_title_and_length_song, filter(check_length_song, song_list)):
#     print(title)


# # 좋아요 수와 제목 글자수의 곱을 출력

# bts_list = []
# for song_dict in song_list:
#     title: str = song_dict["title"]
#     like: int = song_dict["like"]
#     bts_list.append([like, len(title)])

# for title, like in bts_list:
#     print(title * like)
